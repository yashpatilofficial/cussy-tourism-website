...
export default function HomeClient({ initialPackages, homepage }: { initialPackages: any[], homepage: any }) {
  ...
  const heroTitle = homepage?.heroTitle || "Discover the World's Most Beautiful Places"
  const heroDescription = homepage?.heroDescription || "From the majestic Himalayas to pristine beaches, from royal palaces to exotic international getaways — your dream vacation starts here."
  
  const slides = (homepage?.heroSlides?.length > 0) 
    ? homepage.heroSlides.map((s: any) => ({
        src: s.image?.url || s.image || '',
        alt: s.alt || ''
      }))
    : [
  ...
  const statsList = (homepage?.stats?.length > 0)
    ? homepage.stats
    : [
  ...
  const featuresList = (homepage?.features?.length > 0)
    ? homepage.features
    : [
        { icon: '🏨', title: 'Premium Accommodation', description: 'Hand-selected 3 to 5-star hotels and heritage stays curated for comfort and convenience.' },
        { icon: '🍽', title: 'All Meals Included', description: 'Enjoy authentic local cuisine with breakfast, lunch, and dinner included on every tour day.' },
        { icon: '🚐', title: 'Seamless Transport', description: 'Comfortable AC coaches, flights, and ferries — all transport is included in your package.' },
        { icon: '👨‍✈️', title: 'Expert Tour Managers', description: 'Our 200+ experienced tour managers specialise in India and international destinations.' },
        { icon: '💎', title: 'Best Value Itinerary', description: 'Our dedicated research team curates the best value-for-money itineraries for every destination.' },
        { icon: '✈️', title: 'Airfare Included', description: 'Round-trip airfare from major Indian cities is included in most of our tour packages.' }
      ]

  const testimonialsList = (homepage?.testimonials?.length > 0)
  ...
  const ctaTitle = homepage?.ctaTitle || "Ready for Your Next Adventure?"
  const ctaDescription = homepage?.ctaDescription || "Subscribe to our newsletter and get exclusive deals, early access to new tours, and travel tips straight to your inbox."
  const ctaImage = homepage?.ctaImage?.url || homepage?.ctaImage || '/images/destination-bali.png'
    ...
    <>
      ...
      <section className="hero" id="hero">
        ...
        <div className="container hero-content">
          ...
          <h1 dangerouslySetInnerHTML={{ __html: heroTitle.replace(/(Beautiful Places|World's Most)/g, '<em>$1</em>') }}>
          </h1>
          ...
          <div className="hero-stats">
            {statsList.slice(0, 4).map((s: any, i: number) => (
              <div className="hero-stat" key={i}>
                <h3>{s.value.toLocaleString()}{s.suffix}</h3>
                <p>{s.label}</p>
              </div>
            ))}
          </div>
          ...
          <div className="destinations-header reveal">
            <div>
              ...
              <h2 className="section-title">
                Explore Popular <span className="text-gradient">Destinations</span>
              </h2>
              <p className="section-subtitle">
                Handpicked destinations that our travellers love the most. From serene backwaters
      ...
      <section className="features" id="features">
        <div className="container">
          <div className="features-header reveal">
            ...
            <h2 className="section-title">
              All-Inclusive <span className="text-gradient">Tour Packages</span>
            </h2>
            <p className="section-subtitle">
              We take care of every detail so you can focus on creating memories that last a
              lifetime.
            </p>
          </div>
      ...
      <section className="packages" id="packages">
        <div className="container">
          <div className="packages-header reveal">
            ...
            <p className="section-subtitle">
              Carefully crafted journeys that balance adventure, culture, relaxation, and value.
            </p>
          </div>
          ...
          <div className="packages-grid">
            {initialPackages
              ...
              .map((pkg) => (
                <div className="package-card reveal" key={pkg.pid}>
                  <div className="package-card-image">
                    <img src={pkg.img} alt={pkg.title} loading="lazy" />
                    <span className="package-badge">{pkg.badge}</span>
                    <button
                      className={`package-wishlist ${wishlist[pkg.pid] ? 'active' : ''}`}
                      onClick={(e) => toggleWishlist(e, pkg.pid)}
                  ...
                  <div className="package-card-body">
                    ...
                    <div className="package-card-footer">
                      ...
                      <Link href={`/package/${pkg.pid}`} className="btn-book">
                        View Details
                      </Link>
                    </div>
                  </div>
      ...
      <section className="experiences" id="experiences">
        <div className="container">
          <div className="experiences-header reveal">
            ...
            <h2 className="section-title">
              Find Your <span className="text-gradient">Perfect Getaway</span>
            </h2>
            <p className="section-subtitle">
              Specialised tours designed for every occasion, interest, and travel style.
            </p>
          </div>
          <div className="experiences-grid reveal">
            {[
              {
                img: '/images/destination-goa.png',
                icon: '💑',
              ...
              },
              {
                ...
                icon: '👨‍👩‍👧‍👦',
                title: 'Family Tours',
                desc: 'Kid-friendly adventures for all ages',
              },
              {
                img: '/images/hero-adventure.png',
                icon: '🏔',
                title: 'Adventure Tours',
                desc: 'Thrilling treks and extreme sports',
              },
              {
                img: '/images/destination-dubai.png',
                icon: '👑',
                title: 'Luxury Holidays',
                desc: 'Premium 5-star travel experiences',
              },
            ].map((exp, i) => (
          ...
          <div className="stats-inner reveal">
            {statsList.map((s: any, i: number) => (
              <div className="stat-item" key={i}>
                <h3 data-count={s.value} data-suffix={s.suffix}>0</h3>
                <p>{s.label}</p>
              </div>
            ))}
          </div>
      ...
      <section className="testimonials" id="testimonials">
        <div className="container">
          <div className="testimonials-header reveal">
            ...
            <p className="section-subtitle">
              Real experiences from real travellers who chose Cussy Tourism.
            </p>
          </div>
      ...
      <section className="cta-section" id="contact">
        <div className="container">
          <div className="cta-inner reveal">
            <img src={ctaImage} alt="CTA Background" loading="lazy" />
            <h2>
              {ctaTitle.split(' ').map((word: string, i: number) => 
                i === ctaTitle.split(' ').length - 1 ? <span key={i} className="text-gradient">{word}</span> : word + ' '
              )}
            </h2>
            <p>
              {ctaDescription}
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-about">
              ...
              <p>
                Cussy Tourism Pvt. Ltd is one of India's leading travel companies offering
                all-inclusive tour packages to destinations across India and the world. We believe
                travel should be joyful, stress-free, and accessible to everyone.
              </p>
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li>
                  <a href="mailto:info@cussytourism.com">✉ info@cussytourism.com</a>
                </li>
                <li>
      ...
      <style jsx global>{`
        ...
        .nav-logo-link {
          filter: drop-shadow(0 2px 20px rgba(255, 255, 255, 0.95))
